...
echo '<div><p>'.$row["crime_latitude"]."&&split_string&&".$row["crime_longitude"]."&&split_string&&".$row["crime_description"]."&&split_string&&".$row["crime_category"]."&&split_string&&".$row["crime_date"]."&&split_string&&".$row["crime_time"]."&&split_string&&".$row["final_rating"]."&&split_string&&".'<p></div>'; 
}
